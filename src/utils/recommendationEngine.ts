...
const courses: Course[] = [
  {
    ...
    pdfUrl: 'https://drive.google.com/file/d/1iMUW_PSiEN-fTA4Kzp9At4T2RSty9mly/view?usp=drivesdk',
  },
  {
    id: 'data-science',
    ...
    pdfUrl: 'https://drive.google.com/file/d/1iJwJ98q3rC48JP5zIxhvgnJ2t_85mMr5/view?usp=drivesdk',
  },
  {
    id: 'mobile-dev',
    title: 'Mobile App Development',
    description: 'Build cross-platform mobile apps using React Native and modern mobile technologies.',
    category: 'Mobile Development',
    level: 'Intermediate',
    topics: ['react-native', 'mobile', 'ios', 'android'],
    imageUrl: 'https://images.pexels.com/photos/1092644/pexels-photo-1092644.jpeg',
    pdfUrl: 'https://drive.google.com/file/d/1iZUDde8EhIB-cTE36Rlw3W2Fwbr-BLzV/view?usp=drivesdk',
  },
  {
    id: 'cloud-computing',
    title: 'Cloud Computing & DevOps',
    description: 'Learn cloud services, containerization, and modern deployment practices.',
    category: 'Cloud Computing',
    level: 'Advanced',
    topics: ['aws', 'docker', 'kubernetes', 'devops'],
    imageUrl: 'https://images.pexels.com/photos/1181354/pexels-photo-1181354.jpeg',
    pdfUrl: 'https://drive.google.com/file/d/1iZnV35oTnpX6dGpV6lw91f8OQ63_A8HH/view?usp=drivesdk',
  },
  {
    id: 'cybersecurity',
    title: 'Cybersecurity Fundamentals',
    description: 'Master the basics of network security, cryptography, and ethical hacking.',
    ...
    pdfUrl: 'https://drive.google.com/file/d/1i_-25AxAc_P4EiX6oN-h9N1jNqTS6O6d/view?usp=drivesdk',
  },
];

function extractFeatures(quizResults: QuizResult[], quizzes: Quiz[]): number[][] {
  return quizResults
    .map((result) => {
...
export function recommendCourses(quizResults: QuizResult[], quizzes: Quiz[]): Course[] {
  if (quizResults.length === 0) return courses.slice(0, 3);

  try {
    const features = extractFeatures(quizResults, quizzes);
    if (features.length === 0) return courses.slice(0, 3);

    const model = new LogisticRegression({ numSteps: 100, learningRate: 0.5 });
    
    // Prepare simple training data based on performance
    const X = features;
    const y = Float64Array.from(
      features.map(f => (f[0] > 0.7 || f[2] > 0.7) ? 1 : 0)
    );
